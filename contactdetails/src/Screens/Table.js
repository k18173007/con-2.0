...
const RenderRequestBody = (props) => {
  return (
    ...
    <tr key={props.patient.id} role="button" >
      <td onClick={() => props.setDriverData({ driver: props.driver, patient: props.patient, hospital: props.hospital })}>{props.patient.id}</td>
      <td onClick={() => props.setDriverData({ driver: props.driver, patient: props.patient, hospital: props.hospital })}>{props.patient.time}</td>
      <td onClick={() => props.setDriverData({ driver: props.driver, patient: props.patient, hospital: props.hospital })}>{props.patient.requestTime}</td>
      <td onClick={() => props.setDriverData({ driver: props.driver, patient: props.patient, hospital: props.hospital })}>{props.driver.DriverName}</td>
      <td onClick={() => props.setDriverData({ driver: props.driver, patient: props.patient, hospital: props.hospital })}>{props.hospital.hospitalName}</td>
      <td onClick={() => props.setDriverData({ driver: props.driver, patient: props.patient, hospital: props.hospital })}>{props.patient.patientName}</td>
      <td onClick={() => props.setDriverData({ driver: props.driver, patient: props.patient, hospital: props.hospital })}>{props.patient.case}</td>
      <td onClick={() => props.setDriverData({ driver: props.driver, patient: props.patient, hospital: props.hospital })}>{props.patient.plevel}</td>
      <td className="d-flex align-items-center">
        <div className="radio">
          <input type="radio" value="option1" role="button" name="myRadio" id={props.patient.patientName} className="radio__input radio1" />
